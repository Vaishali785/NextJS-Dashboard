...
import { assignmentsData, examsData, resultsData, role } from "@/app/lib/data"
import { Result } from "@/app/lib/type"
	...
	const renderRow = (item: Result) => {
		return (
			...
			>
				...
				<td className=" text-xs">{item.student}</td>
				<td className="hidden md:table-cell text-xs">{item.score}</td>
				<td className="hidden md:table-cell text-xs">{item.teacher}</td>
				<td className="hidden md:table-cell text-xs">{item.class}</td>
				<td className="hidden md:table-cell text-xs">{item.date}</td>
				<td>
